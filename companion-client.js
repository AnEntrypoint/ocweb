...
function call(method, params) {
  return new Promise((resolve, reject) => {
    ...
    setTimeout(() => { if (pendingCalls.has(id)) { pendingCalls.delete(id); reject(new Error("timeout")); } }, 35000);
  });
}
...
export { connect, disconnect, isConnected, call, shellExec, fsRead, fsWrite, fsList, fsExists, fsDelete, fsStat, gitStatus, gitLog, gitDiff, processSpawn, ping };

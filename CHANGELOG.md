...
- validated: opencode TUI renders in browser WASM terminal — 10 distinct ANSI colors (white/cyan/yellow/red/amber/blue) confirmed via xterm-text-layer canvas pixel analysis; opencode full TUI interface running after XDG_DATA_HOME=/tmp fix
